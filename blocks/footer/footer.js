...
export default async function decorate(block) {
  ...
  // if (fragment && fragment.firstElementChild) {
    ...
    //   if (block.children[index].classList.contains('columns-wrapper')) {
    //     return block.children[index];
    //   } else if (block.children[index].classList.contains('columns-wrapper')) {
    //     return block.children[index];
    //   }
    //   return null;
    // };
    
    // const container = findColumnWrapper(block, 0);
    ...
    // const bottomContent = findColumnWrapper(block, 1);
    // if (bottomContent) {
