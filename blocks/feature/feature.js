...
export default function decorate(block) {
  ...
  if (linkField) {
    ...
    if (originalLink) {
      ...
      buttonP.appendChild(linkElement);
    }
    linkTextDiv.appendChild(buttonP);
